...
%		
		...
		\begin{minipage}{0.3\linewidth}
			...
			\end{tikzpicture}
		\end{minipage}
		\caption{Exercise~\ref{it:diff12}}
		\label{fig:diff12}
	\end{figure}	
	
	
	\item For which values of $x$ does the following functions have slope equal to $2$.
	\begin{align*}
	...
	\item \label{it:diff11} Determine for each of the blue graphs in Figure~\ref{fig:diff11} which of the red graphs corresponds to its derivative.
		\begin{figure}
		\centering
...
\begin{minipage}{0.3\linewidth}
	...
	\end{tikzpicture}
	\end{minipage}
	\caption{Exercise~\ref{it:diff11}}
	\label{fig:diff11}
	\end{figure}	
