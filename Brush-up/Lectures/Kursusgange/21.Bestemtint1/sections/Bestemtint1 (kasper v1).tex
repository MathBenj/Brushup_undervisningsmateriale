\title{\Huge \textbf{Bestemte integraler \\(introduktion, regneregler)}\vspace{-1.5cm}}
\date{}
\author{}
\maketitle
...
\paragraph*{Eksempel:}
\begin{enumerate}
\item Find arealet mellem $f(x)=12-2x^2$ og $g(x)=x^2$ i intervallet $[-2,2]$:

Vi udregner det bestemte integral af de to funktioner trukket fra hinanden
\begin{align*}
